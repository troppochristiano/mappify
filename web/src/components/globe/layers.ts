    ...
    layers: [
      { id: LAYER.space, type: 'background', paint: { 'background-color': SPACE } },
      {
        ...
        paint: {
          ...
          'raster-brightness-max': ['interpolate', ['linear'], ['zoom'], 4, 0.78, 7, 1],
          'raster-saturation': ['interpolate', ['linear'], ['zoom'], 4, -0.15, 7, 0],
      ...
      },
      {
        ...
        paint: {
          ...
          'line-opacity': ['interpolate', ['linear'], ['zoom'], 4.5, 0, 7.5, 0.5],
        },
      },
      {
        id: LAYER.links,
